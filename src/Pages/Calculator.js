...
function Calculator() {
  ...
  const calculatePropertyValue = () => {
    ...
    const calculatedValue = (baseValue + landValue + roomsValue) * locationMultiplier * conditionMultiplier
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 15.75 3 12m0 0 3.75-3.75M3 12h18" />
      ...
      <CardFooter>
        <Button className="w-full" onClick={handleSaveCalculation}>Save Calculation</Button>
      </CardFooter>
    </Card>
