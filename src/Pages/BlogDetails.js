    ...
    <div className='bg-black h-fit'>
      ...
      <div className='grid grid-cols-5 gap-9 p-2'>
        ...
        <div className='col-span-3'>
          <button className='text-white tracking-tighter border-white border-2 text-xl rounded-full px-7 hover:bg-green-400 hover:border-black hover:text-black mt-2'>
            Edit
          </button>
          ...
          <h1 className='text-white text-4xl tracking-tighter '>
            10 things about house hunting
          </h1>

          <h1 className='text-white text-lg tracking-tighter mt-9'>
            Created on
          </h1>

          <h1 className='text-white text-2xl tracking-tighter mt-3'>
            10th March 2023
          </h1>

          <h1 className='text-white text-lg tracking-tighter mt-9'>Details</h1>

          <h1 className='text-white text-xl tracking-tighter mt-5 '>
